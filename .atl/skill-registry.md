...
- /home/strocsdev/.config/agents/skills
- /home/strocsdev/.agents/skills
- /home/strocsdev/.config/opencode/skills
- /home/strocsdev/.gemini/skills
- /home/strocsdev/.codex/skills
...
### brainstorming
- Path: /home/strocsdev/.agents/skills/brainstorming/SKILL.md
...
### branch-pr
- Path: /home/strocsdev/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/strocsdev/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/strocsdev/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/strocsdev/.config/opencode/skills/comment-writer/SKILL.md
...
### find-skills
- Path: /home/strocsdev/.agents/skills/find-skills/SKILL.md
...
### frontend-design
- Path: /home/strocsdev/.agents/skills/frontend-design/SKILL.md
...
### git-commit
- Path: /home/strocsdev/.agents/skills/git-commit/SKILL.md
...
### go-testing
- Path: /home/strocsdev/.config/opencode/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/strocsdev/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/strocsdev/.config/opencode/skills/judgment-day/SKILL.md
...
### next-best-practices
- Path: /home/strocsdev/.agents/skills/next-best-practices/SKILL.md
...
### playwright
- Path: /home/strocsdev/.config/opencode/skills/playwright/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### react-19
- Path: /home/strocsdev/.config/opencode/skills/react-19/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### router
- Path: /home/strocsdev/.config/opencode/skills/router/SKILL.md
- Trigger: Deterministic routing rules for delegating work to subagents. Use for triage, delegation decisions, or routing requests to specialized subagents.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/strocsdev/.config/opencode/skills/skill-creator/SKILL.md
...
### tailwind-4
- Path: /home/strocsdev/.config/opencode/skills/tailwind-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript
- Path: /home/strocsdev/.config/opencode/skills/typescript/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### vercel-react-best-practices
- Path: /home/strocsdev/.agents/skills/vercel-react-best-practices/SKILL.md
...
### work-unit-commits
- Path: /home/strocsdev/.config/opencode/skills/work-unit-commits/SKILL.md
...
### zod-4
- Path: /home/strocsdev/.config/opencode/skills/zod-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### zustand-5
- Path: /home/strocsdev/.config/opencode/skills/zustand-5/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
