...
2. **Delegate Research**: Use @planning to invoke the planning-subagent for comprehensive context gathering. Instruct it to work autonomously without pausing.
...
### 2A. Implement Phase
1. Use @implementator to invoke the implement-subagent with:
...
1. Use @review to invoke the code-review-subagent with:
