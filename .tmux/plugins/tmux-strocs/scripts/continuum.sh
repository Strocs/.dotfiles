...
# configuration
# @sonokai-continuum-mode default (countdown|time|alert|interval)
# @sonokai-continuum-time-threshold 15

alert_mode="@sonokai-continuum-mode"
time_threshold="@sonokai-continuum-time-threshold"
warn_threshold=360
first_save="@sonokai-continuum-first-save"
